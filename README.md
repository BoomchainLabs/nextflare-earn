# Earn App Python API library

[![PyPI version](https://img.shields.io/pypi/v/earn_app.svg)](https://pypi.org/project/earn_app/)
...
pip install git+ssh://git@github.com/stainless-sdks/earn-app-python.git
```

> [!NOTE]
> Once this package is [published to PyPI](https://app.stainless.com/docs/guides/publish), this will become: `pip install --pre earn_app`
...
Simply import `AsyncEarnApp` instead of `EarnApp` and use `await` with each API call:
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/earn-app-python/tree/main/src/earn_app/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/earn-app-python/tree/main/src/earn_app/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/earn-app-python/issues) with questions, bugs, or suggestions.
