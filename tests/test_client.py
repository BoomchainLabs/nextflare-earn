...
from earn_app._utils import maybe_transform
from earn_app._models import BaseModel, FinalRequestOptions
from earn_app._constants import RAW_RESPONSE_HEADER
...
from earn_app.types.user_create_params import UserCreateParams
...
class TestEarnApp:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                "/users",
                body=cast(object, maybe_transform(dict(wallet_address="walletAddress"), UserCreateParams)),
